...
export const metadata: Metadata = {
  title: "Bibbio Coffeeshop - Premium Coffee & Pastries",  description: "Discover Bibbio Coffeeshop: artisan coffee, fresh pastries, and a warm atmosphere. Visit us daily for specialty blends and memorable experiences.",  keywords: "coffeeshop, premium coffee, espresso, pastries, cafe, specialty coffee, artisan, local",  metadataBase: new URL('https://example.com'),
  alternates: {
  ...
  openGraph: {
    title: "Bibbio Coffeeshop - Premium Coffee & Pastries",    description: "Discover Bibbio Coffeeshop: artisan coffee, fresh pastries, and a warm atmosphere.",    type: "website",    siteName: "Bibbio Coffeeshop",    images: [{
      url: "https://img.b2bpic.net/free-photo/multilayer-coffee-glass-with-cookie-saucer_23-2147908388.jpg",      alt: "Bibbio Coffeeshop - Premium Coffee"
    }]
  },
  twitter: {
    card: "summary_large_image",    title: "Bibbio Coffeeshop - Premium Coffee & Pastries",    description: "Discover Bibbio Coffeeshop: artisan coffee, fresh pastries, and a warm atmosphere.",    images: ["https://img.b2bpic.net/free-photo/multilayer-coffee-glass-with-cookie-saucer_23-2147908388.jpg"]
  }
};
